...
void UAbilitySystemComponent::NetMulticast_InvokeGameplayCueAdded(const struct FGameplayTag& GameplayCueTag, const struct FPredictionKey& PredictionKey, const struct FGameplayEffectContextHandle& EffectContext)
{
	...
	struct { const struct FGameplayTag& GameplayCueTag; const struct FPredictionKey& PredictionKey; const struct FGameplayEffectContextHandle& EffectContext; } UAbilitySystemComponent_NetMulticast_InvokeGameplayCueAdded_Params{ GameplayCueTag, PredictionKey, EffectContext };

	this->ProcessEvent(NetMulticast_InvokeGameplayCueAddedFn, &UAbilitySystemComponent_NetMulticast_InvokeGameplayCueAdded_Params);
}
...
{
	static auto NetMulticast_InvokeGameplayCueExecutedFn = FindObject<UFunction>(L"/Script/GameplayAbilities.AbilitySystemComponent.NetMulticast_InvokeGameplayCueAdded");
	struct { const struct FGameplayTag& GameplayCueTag; const struct FPredictionKey& PredictionKey; const struct FGameplayEffectContextHandle& EffectContext; } UAbilitySystemComponent_NetMulticast_InvokeGameplayCueExecuted_Params{ GameplayCueTag, PredictionKey, EffectContext };

	this->ProcessEvent(NetMulticast_InvokeGameplayCueExecutedFn, &UAbilitySystemComponent_NetMulticast_InvokeGameplayCueExecuted_Params);
}
